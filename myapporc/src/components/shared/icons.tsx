import {
  ...
  VideoIcon,
  Captions,
  Mic,         // đã import Mic cho dubbing
  List,        // thêm import List cho playlist
} from "lucide-react";
...
export const Icons = {
  ...
  playlist: List,        // Thêm key playlist dùng icon List
  dubbing: Mic,          // Thêm key dubbing dùng icon Mic
  render: Zap,           // Thêm key render dùng icon Zap
  subtitle: Captions,    // Thêm key subtitle dùng icon Captions
  user: User,
  video: VideoIcon,
